...
static struct msm_camera_i2c_reg_conf sr130pc20_camcorder_mode_50hz[] = {
/*0 Page*/
{0x03, 0x00,},
{0x01, 0x01,},	/*sleep*/
{0x01, 0x03,},	/*s/w reset*/
...
static struct msm_camera_i2c_reg_conf sr130pc20_camcorder_mode_60hz[] = {
/*0 Page*/
{0x03, 0x00,},
{0x01, 0x01,},	/*sleep*/
{0x01, 0x03,},	/*s/w reset*/
...
static struct msm_camera_i2c_reg_conf sr130pc20_Preview_for_initial_50hz[] = {
{0x03, 0x00,},
{0x01, 0x01,},/*sleep*/
{0xd0, 0x05,},/*Pll Off*/
{0x03, 0x20,},
...
static struct msm_camera_i2c_reg_conf sr130pc20_Preview_for_initial_60hz[] = {
{0x03, 0x00,},
{0x01, 0x01,},/*sleep*/
{0xd0, 0x05,},/*Pll Off*/
{0x03, 0x20,},
...
{0x14, 0x43,}, /*83*/
{0x03, 0x20,},
{0x10, 0x8c,},  /*AE ON ({0x8c, 0x:6}0Hz   {0x9c, 0x:5}0Hz)*/
{0x03, 0x22,},
{0x10, 0xfd,},  /*AWB ON*/
...
static struct msm_camera_i2c_reg_conf sr130pc20_Init_Reg_60hz[] = {
{0x03, 0x00,},
{0x01, 0x01,},	/*sleep*/
{0x01, 0x03,},	/*s/w reset*/
{0x01, 0x01,},	/*sleep*/
...
{0xf5, 0x00,}, /* dsshin --> h blank option*/
{0x03, 0x11,},	/*page 11 D_LPF	*/
{0x10, 0x3f,},	/*B[6]:Blue En  Dlpf on[4:0] Sky over off : {0x7f, 0x->}3f*/
{0x11, 0x20,},	/* Uniform Full GbGr/OV-Nr*/
{0x12, 0x80,},	/*Blue MaxOpt  blue sky max filter optoin rate : 0 {0xc0, 0x->}80*/
...
{0x3c, 0x3f,},	
{0x3d, 0x16,},	/*indoor L th*/
{0x3e, 0x30,},	/*indoor gain ratio    {0x44, 0x  }6a */
{0x3f, 0x1a,},	/*indoor H lum         {0x12, 0x  }18	*/
{0x40, 0x60,},	/*indoor M lum	       {0x18, 0x  }1c*/
{0x41, 0x1a,},	/*indoor L lum         {0x18, 0x  }3e*/
{0x42, 0x98,},	/*dark1 H th*/
{0x43, 0x28,},	/*dark1 L th*/
{0x44, 0x65,},	/*dark1 gain ratio*/
{0x45, 0x16,},	/*dark1 H lum         0x38, 0x->0x28, 0x  */
{0x46, 0x30,},	/*dark1 M lum         0x27, 0x->0x17, 0x*/
{0x47, 0x34,},	/*dark1 L lum         0x20, 0x->0x1a, 0x */
{0x48, 0x90,},	/*dark2 H th*/
{0x49, 0x2a,},	/*dark2 L th*/
{0x4a, 0x65,},	/*dark2 gain ratio*/
{0x4b, 0x18,},	/*dark2 H lum */
...
{0x52, 0x31,},	/*dark3 M lum */
{0x53, 0x36,},	/*dark3 L lum */
{0x5a, 0x3f,},	/*blue sky mode out1/2 enable  {0x27, 0x->}3f */
{0x5b, 0x00,},
{0x5c, 0x9f,},	
{0x60, 0x3f,},	/*GbGr all enable*/
{0x62, 0x0f,},	/*GbGr offset*/
...
{0x4f, 0x30,},	/*indoor M lum*/
{0x50, 0x12,},	/*indoor L lum */
{0x51, 0x70,},	/*indoor ratio  {0x10, 0x -}> {0x45, 0x}*/
{0x52, 0xa8,},	/*dark1 H th*/
{0x53, 0x30,},	/*dark1 L th	*/
{0x54, 0x28,},	/*dark1 H lum */
{0x55, 0x3e,},	/*dark1 M lum*/
...
{0xae, 0x07,},	/*10825*/
{0xaf, 0x07,},	/*10825*/
{0xc5, 0x58,},	/*BlueRange   2010.8.25    {0x40, 0x->}23 */
{0xc6, 0x20,},	/*GreenRange  2010.8.25    {0x3b, 0x->}20 */
{0xd0, 0x88,},	/*2010.8.25*/
{0xd1, 0x80,},
{0xd2, 0x17,},/*preview 17, full 67*/
{0xd3, 0x00,},
